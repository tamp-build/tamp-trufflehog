...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-trufflehog";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests only — integration tests need trufflehog on PATH.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.TruffleHog.V3.Tests" / "Tamp.TruffleHog.V3.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.TruffleHog.V3" / "Tamp.TruffleHog.V3.csproj");
